...
def main():
    ...
    st.sidebar.title("Binarry Classification Web App") 
    st.markdown("Are these mushroom editable or piosionous ?") 
    st.sidebar.markdown("Are these mushroom editable or piosionous ?") 
    ...
    if Classifier == 'SVM':
        ...
        gamma = st.sidebar.radio("Gamma kernel Coeefficient", ("scale", "auto"), key='gamma')
